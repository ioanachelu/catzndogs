...
batch_size = 256  # try 4, 8, 16, 32, 64, 128, 256 dependent on CPU/GPU memory capacity (powers of 2 values).
...
top_model_weights_path = './models/top_model_weights_inception_v2.h5'
final_model_weights_path = './models/model_weights_inception_v2.h5'
model_path = './models/model_inception_v2.json'
